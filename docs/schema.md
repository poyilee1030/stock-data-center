...
The last four are derived (Steps 26-b through 26-d): computed from the latest inputs and
...
(Step 26-c) the third and `c3f1f515e3df` (Step 26-d) the fourth. Their downgrades drop them without a guard: every derived
