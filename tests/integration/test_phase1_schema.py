...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("corporate_action_versions", "corporate_action", "security_id, source, action_type, ex_date", ":security_id, 'official', 'cash_dividend', DATE '2026-09-10'", ", announcement_date", ", DATE '2026-09-01'"),
