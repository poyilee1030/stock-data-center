...
ROADMAP §20 is the authoritative ledger. Its current snapshot identifies Steps 1–18, 19-a through 19-e, 20-a through 20-d, 21-a, 21-b, 22-a through 22-c, 23-a through 24-b and 35-a as MERGED, 26-a as IN REVIEW, and labels Step 35-b-1 as `THIS STEP` (a contextual marker, not an additional status value):
...
Step 35-b-1 schema v2: exchange-daily write path       THIS STEP
Step 35-b-2 schema v2: drop the 8 domains' v1 path      PLANNED
```
