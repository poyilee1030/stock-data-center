...
ROADMAP §20 is the authoritative ledger. Its current snapshot identifies Steps 1–18, 19-a through 19-e, 20-a through 20-d, 21-a, 21-b and 22-a through 22-c as MERGED and labels Step 23-a as `THIS STEP` (a contextual marker, not an additional status value):
...
Step 23-a financial statements: iXBRL parser            THIS STEP
Step 23-b financial statements: adapters + import path  PLANNED
Step 23-c financial statements: backfill + reconcile    PLANNED
