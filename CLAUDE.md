...
ROADMAP §20 is the authoritative ledger. Its current snapshot identifies Steps 1–17, 18-a, 18-b and 19-a through 19-e as MERGED and labels Step 18-c as `THIS STEP` (a contextual marker, not an additional status value):
...
Step 18-c official valuation                            THIS STEP
