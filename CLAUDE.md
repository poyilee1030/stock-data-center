...
ROADMAP §20 is the authoritative ledger. Its current snapshot identifies Steps 1–18, 19-a through 19-e, 20-a through 20-d, 21-a, 21-b, 22-a through 22-c, 23-a through 24-b, 35-a, 35-b-1, 35-c-1 through 35-c-4, 35-d-1 through 35-d-3, 26-b through 26-f, 27-a through 27-c, 36, 37-a through 37-c and 38-a as MERGED, and 26-a, 29, 32 and 35-b-2 as SUPERSEDED; no step is IN REVIEW; no step is currently marked `THIS STEP` (a contextual marker, not an additional status value):
...
Step 39  historical industry classification            PLANNED (exchange reclassification announcements)
```
